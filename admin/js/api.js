...
// API để lấy dữ liệu danh sách các sản phẩm
const apiDienthoai=()=>{
    return new Promise((Ket_qua, Loi) => {
        let Du_lieu = {}
        let Xu_ly_HTTP = new XMLHttpRequest()
...
// API dùng để sửa đổi các sản phẩm
